...
class MT5Provider extends ChangeNotifier {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      if (profile != null) {
        ...
        _credentials =
            credentials.where((cred) => cred.platformName == 'MT5').firstOrNull;
      }
      _isInitialized = true;
    } catch (e) {
  ...
  /// Connect to MT5 with new credentials
  Future<bool> connect({
    ...
    try {
      ...
      if (e is ApiError) {
        ...
        _error = 'Failed to connect to MT5: ${e.toString()}';
      }
      return false;
    } finally {
      _isConnecting = false;
  ...
  Future<bool> updateCredentials({
    ...
    if (_credentials == null) {
      _error = 'No MT5 credentials found';
      notifyListeners();
      return false;
    }
    ...
    try {
      ...
      if (e is ApiError) {
        ...
        _error = 'Failed to update MT5 credentials: ${e.toString()}';
      }
      return false;
    } finally {
      _isConnecting = false;
