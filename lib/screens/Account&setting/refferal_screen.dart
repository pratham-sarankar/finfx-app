...
class ReferralScreen extends StatefulWidget {
  ...
  @override
  State<ReferralScreen> createState() => _Reffle_codeState();
}

class _Reffle_codeState extends State<ReferralScreen> {
  @override
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        "Each time the friends you sign up, you get a commission. Commission is calculated accoding to the policy decided by the admin.",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  profileProvider.profile?.referralCode ?? "",
                                  style: TextStyle(
                                    fontSize: 19,
                                    color: colorScheme.onSurface,
                                    fontFamily: "Manrope-Bold",
