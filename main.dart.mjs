...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1634: (x0,x1) => x0.getAttribute(x1),
      _1635: (x0,x1) => x0.createElement(x1),
      _1636: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1638: (x0,x1) => x0.initialize(x1),
      _1639: (x0,x1) => x0.initTokenClient(x1),
      _1640: (x0,x1) => x0.initCodeClient(x1),
      _1642: (x0,x1) => x0.warn(x1),
      _1643: x0 => x0.disableAutoSelect(),
      _1644: (x0,x1) => x0.getItem(x1),
      _1645: (x0,x1) => x0.removeItem(x1),
      _1646: (x0,x1,x2) => x0.setItem(x1,x2),
      _1650: (x0,x1) => x0.querySelector(x1),
      _1651: (x0,x1) => x0.querySelector(x1),
      _1677: (x0,x1,x2,x3,x4,x5,x6,x7) => ({apiKey: x0,authDomain: x1,databaseURL: x2,projectId: x3,storageBucket: x4,messagingSenderId: x5,measurementId: x6,appId: x7}),
      _1678: (x0,x1) => globalThis.firebase_core.initializeApp(x0,x1),
      _1680: () => globalThis.firebase_core.getApp(),
      _1683: () => globalThis.firebase_core.SDK_VERSION,
      _1690: x0 => x0.apiKey,
      _1692: x0 => x0.authDomain,
      _1694: x0 => x0.databaseURL,
      _1696: x0 => x0.projectId,
      _1698: x0 => x0.storageBucket,
      _1700: x0 => x0.messagingSenderId,
      _1702: x0 => x0.measurementId,
      _1704: x0 => x0.appId,
      _1706: x0 => x0.name,
      _1707: x0 => x0.options,
      _1708: (x0,x1) => x0.debug(x1),
      ...
      _1711: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1712: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1713: (x0,x1) => x0.createScriptURL(x1),
      _1714: (x0,x1,x2) => x0.createScript(x1,x2),
      _1715: (x0,x1) => x0.appendChild(x1),
      _1716: (x0,x1) => x0.appendChild(x1),
      _1717: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1717(f,arguments.length,x0) }),
      _1730: x0 => new Array(x0),
      _1732: x0 => x0.length,
      _1734: (x0,x1) => x0[x1],
      _1735: (x0,x1,x2) => x0[x1] = x2,
      _1738: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1740: x0 => new Int8Array(x0),
      _1741: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1742: x0 => new Uint8Array(x0),
      _1750: x0 => new Int32Array(x0),
      _1752: x0 => new Uint32Array(x0),
      _1754: x0 => new Float32Array(x0),
      _1756: x0 => new Float64Array(x0),
      ...
      _1767: (o, a) => o + a,
      _1788: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1789: () => new TextDecoder("utf-8", {fatal: true}),
      _1790: () => new TextDecoder("utf-8", {fatal: false}),
      _1791: x0 => new WeakRef(x0),
      _1792: x0 => x0.deref(),
      _1798: Date.now,
      ...
      _1811: () => globalThis.WeakRef,
      _1822: s => JSON.stringify(s),
      _1823: s => printToConsole(s),
      _1824: a => a.join(''),
      _1825: (o, a, b) => o.replace(a, b),
      _1827: (s, t) => s.split(t),
      _1828: s => s.toLowerCase(),
      _1829: s => s.toUpperCase(),
      _1830: s => s.trim(),
      _1831: s => s.trimLeft(),
      _1832: s => s.trimRight(),
      _1834: (s, p, i) => s.indexOf(p, i),
      _1835: (s, p, i) => s.lastIndexOf(p, i),
      _1836: (s) => s.replace(/\$/g, "$$$$"),
      _1837: Object.is,
      _1838: s => s.toUpperCase(),
      _1839: s => s.toLowerCase(),
      _1840: (a, i) => a.push(i),
      _1844: a => a.pop(),
      _1845: (a, i) => a.splice(i, 1),
      _1847: (a, s) => a.join(s),
      _1848: (a, s, e) => a.slice(s, e),
      _1850: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1851: a => a.length,
      _1853: (a, i) => a[i],
      _1854: (a, i, v) => a[i] = v,
      _1856: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1857: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      ...
      _1860: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1861: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1862: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1863: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1865: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1866: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      ...
      _1913: o => Object.keys(o),
      _1914: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1915: (handle) => clearTimeout(handle),
      _1916: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1917: (handle) => clearInterval(handle),
      _1918: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1919: () => Date.now(),
      _1929: () => new AbortController(),
      _1930: x0 => x0.abort(),
      _1931: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1932: (x0,x1) => globalThis.fetch(x0,x1),
      _1933: (x0,x1) => x0.get(x1),
      _1934: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1934(f,arguments.length,x0,x1,x2) }),
      _1935: (x0,x1) => x0.forEach(x1),
      _1936: x0 => x0.getReader(),
      _1937: x0 => x0.read(),
      _1938: x0 => x0.cancel(),
      _1959: x0 => x0.trustedTypes,
      _1960: (x0,x1) => x0.src = x1,
      _1961: (x0,x1) => x0.createScriptURL(x1),
      _1962: x0 => x0.nonce,
      _1963: (x0,x1) => x0.debug(x1),
      _1964: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1964(f,arguments.length,x0) }),
      _1965: x0 => ({createScriptURL: x0}),
      _1966: (x0,x1) => x0.appendChild(x1),
      _1967: (x0,x1) => x0.querySelectorAll(x1),
      _1968: (x0,x1) => x0.item(x1),
      _1969: (x0,x1) => x0.getAttribute(x1),
      _1970: (x0,x1) => x0.key(x1),
      _1971: x0 => x0.trustedTypes,
      _1973: (x0,x1) => x0.text = x1,
      _1989: (s, m) => {
        try {
      ...
      _1990: (x0,x1) => x0.exec(x1),
      _1991: (x0,x1) => x0.test(x1),
      _1992: (x0,x1) => x0.exec(x1),
      _1993: (x0,x1) => x0.exec(x1),
      _1994: x0 => x0.pop(),
      _1996: o => o === undefined,
      _2015: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _2017: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _2018: o => o instanceof RegExp,
      _2019: (l, r) => l === r,
      _2020: o => o,
      _2021: o => o,
      _2022: o => o,
      ...
      _2024: o => o.length,
      _2027: (o, i) => o[i],
      _2028: f => f.dartFunction,
      _2029: l => arrayFromDartList(Int8Array, l),
      _2030: l => arrayFromDartList(Uint8Array, l),
      _2031: l => arrayFromDartList(Uint8ClampedArray, l),
      _2032: l => arrayFromDartList(Int16Array, l),
      _2033: l => arrayFromDartList(Uint16Array, l),
      _2034: l => arrayFromDartList(Int32Array, l),
      _2035: l => arrayFromDartList(Uint32Array, l),
      _2036: l => arrayFromDartList(Float32Array, l),
      _2037: l => arrayFromDartList(Float64Array, l),
      _2038: x0 => new ArrayBuffer(x0),
      _2039: (data, length) => {
      ...
      _2040: l => arrayFromDartList(Array, l),
      _2041: () => ({}),
      _2042: () => [],
      _2043: l => new Array(l),
      _2044: () => globalThis,
      ...
      _2150: () => globalThis.google.accounts.oauth2,
      ...
      _2161: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12) => ({client_id: x0,scope: x1,include_granted_scopes: x2,redirect_uri: x3,callback: x4,state: x5,enable_granular_consent: x6,enable_serial_consent: x7,login_hint: x8,hd: x9,ux_mode: x10,select_account: x11,error_callback: x12}),
      _2163: x0 => x0.code,
      _2166: x0 => x0.error,
      ...
      _2171: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => ({client_id: x0,callback: x1,scope: x2,include_granted_scopes: x3,prompt: x4,enable_granular_consent: x5,enable_serial_consent: x6,login_hint: x7,hd: x8,state: x9,error_callback: x10}),
      _2172: x0 => x0.requestAccessToken(),
      _2173: (x0,x1) => x0.requestAccessToken(x1),
      _2176: (x0,x1,x2,x3,x4,x5,x6) => ({scope: x0,include_granted_scopes: x1,prompt: x2,enable_granular_consent: x3,enable_serial_consent: x4,login_hint: x5,state: x6}),
      _2177: x0 => x0.access_token,
      _2178: x0 => x0.expires_in,
      _2181: x0 => x0.token_type,
      _2184: x0 => x0.error,
      _2187: x0 => x0.type,
      _2192: () => globalThis.google.accounts.id,
      ...
      _2243: x0 => x0.error,
      _2245: x0 => x0.credential,
      _2256: x0 => globalThis.onGoogleLibraryLoad = x0,
      _2257: f => finalizeWrapper(f, function() { return dartInstance.exports._2257(f,arguments.length) }),
      _2595: (x0,x1) => x0.nonce = x1,
      _3641: (x0,x1) => x0.src = x1,
      _3643: (x0,x1) => x0.type = x1,
      _3647: (x0,x1) => x0.async = x1,
      _3649: (x0,x1) => x0.defer = x1,
      _3651: (x0,x1) => x0.crossOrigin = x1,
      _3653: (x0,x1) => x0.text = x1,
      _4128: () => globalThis.window,
      _4172: x0 => x0.document,
      _4456: x0 => x0.trustedTypes,
      _4458: x0 => x0.localStorage,
      _4805: x0 => x0.length,
      _6832: x0 => x0.signal,
      _6842: x0 => x0.length,
      _6893: x0 => x0.baseURI,
      _6910: () => globalThis.document,
      _7005: x0 => x0.head,
      _7354: (x0,x1) => x0.id = x1,
      _7381: x0 => x0.children,
      _8735: x0 => x0.value,
      _8737: x0 => x0.done,
      _9458: x0 => x0.url,
      _9460: x0 => x0.status,
      _9462: x0 => x0.statusText,
      _9463: x0 => x0.headers,
      _9464: x0 => x0.body,
      _13129: x0 => x0.name,
      _13857: () => globalThis.console,
